...
public class PasswordStorage {
    ...
    public static final String PRF = "HmacSHA512";
    public static final String PBKDF_2_PREFIX = "PBKDF2With";
    ...
    public static final int PRF_INDEX = 0;
    ...
    public static boolean verifyPassword(char[] password, String correctHash)
        ...
        String prf = params[PRF_INDEX];
        // Compute the hash of the provided password, using the same salt,
        // iteration count, and hash length
        byte[] testHash = pbkdf2(prf, password, salt, iterations, hash.length);
    ...
    private static byte[] pbkdf2(String prf, char[] password, byte[] salt, int iterations, int bytes)
            throws CannotPerformOperationException {
        try {
            PBEKeySpec spec = new PBEKeySpec(password, salt, iterations, bytes * 8);
            SecretKeyFactory skf = SecretKeyFactory.getInstance(PBKDF_2_PREFIX + prf);
